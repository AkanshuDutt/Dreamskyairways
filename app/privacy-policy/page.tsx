      ...
      <main className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-16 lg:py-24">
        <div className="prose prose-lg max-w-none prose-headings:text-[#0E5B63] prose-a:text-[#0E5B63] hover:prose-a:underline">
          ...
          <section className="mb-20">
            ...
            <p>
              Welcome to our Privacy Policy & Pricing Policy. As a trusted
              provider of visa assistance, domestic and international travel planning, and
              travel insurance services, we understand the sensitive nature of
              the personal information you share with us during the visa
              application, insurance purchase, and travel booking process.
            </p>
            <p className="mt-6">
          ...
          <section className="mb-20 bg-white/60 backdrop-blur-sm p-8 md:p-10 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <p>
              ...
              visa, travel insurance, and travel-related services. We never sell
