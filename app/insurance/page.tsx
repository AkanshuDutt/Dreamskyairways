    ...
    <main className="w-ful mt-15">
      ...
      <section className="py-14 px-4 max-w-5xl mx-auto text-center">
        ...
        <p className="text-gray-600 leading-relaxed">
          Travel insurance protects you financially against unexpected events
          such as medical emergencies, flight delays, baggage loss, trip
          cancellations, and visa issues. Whether you are traveling for leisure,
          business, studies, or adventure, the right insurance ensures peace of
